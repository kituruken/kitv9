...
NDefines.NEconomy.LAND_TECH_MAINTENANCE_IMPACT = 0.03 -- slightly increased maintanance penalty per mil tec, vanilla is 0.02	
...
NDefines.NMilitary.STRELSKY_STARTING_STRENGTH = 0.1
...
NDefines.NMilitary.CREATE_CAWA_MIL_COST = 4					-- Cost to create Cawa (per unit)
